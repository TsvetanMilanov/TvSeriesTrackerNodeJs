            ...
            User.find()
                .then(function(data) {
                    if (data.length <= 0) {
                        ...
                        regularUser.password = encryption.createHash(encryption.createHash('regular'));
                        ...
                        moderatorUser.password = encryption.createHash(encryption.createHash('moderator'));
                        ...
                        bannedUser.password = encryption.createHash(encryption.createHash('banned'));
